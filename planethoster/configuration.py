...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://api.planethoster.net"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("planethoster")
            ...
            'api_sandbox':
                {
                    ...
                    'in': 'header',
                    'key': 'X-API-SANDBOX',
                    'value': self.get_api_key_with_prefix('X-API-SANDBOX')
                },
            'api_user':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-API-USER',
                    'value': self.get_api_key_with_prefix('X-API-USER')
                },
        }
