...
class EmailSuspendBody(object):
    ...
    """
    swagger_types = {
        'emails': 'N0capiemailsuspendEmails',
        'id': 'object'
    }
    ...
    def __init__(self, emails=None, id=None):  # noqa: E501
        """EmailSuspendBody - a model defined in Swagger"""  # noqa: E501
        self._emails = None
        self._id = None
    ...
    @property
    def emails(self):
        """Gets the emails of this EmailSuspendBody.  # noqa: E501


        :return: The emails of this EmailSuspendBody.  # noqa: E501
        :rtype: N0capiemailsuspendEmails
        """
        return self._emails

    @emails.setter
    def emails(self, emails):
        """Sets the emails of this EmailSuspendBody.


        :param emails: The emails of this EmailSuspendBody.  # noqa: E501
        :type: N0capiemailsuspendEmails
        """
        if emails is None:
    ...
    @property
    def id(self):
        """Gets the id of this EmailSuspendBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this EmailSuspendBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EmailSuspendBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this EmailSuspendBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailSuspendBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailSuspendBody):
            return False
