...
class UserRemovesshkeyBody(object):
    ...
    def __init__(self, key=None, id=None):  # noqa: E501
        """UserRemovesshkeyBody - a model defined in Swagger"""  # noqa: E501
        self._key = None
        self._id = None
    ...
    @property
    def key(self):
        """Gets the key of this UserRemovesshkeyBody.  # noqa: E501

        SSH key fingerprint.  # noqa: E501

        :return: The key of this UserRemovesshkeyBody.  # noqa: E501
        :rtype: object
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this UserRemovesshkeyBody.

        SSH key fingerprint.  # noqa: E501

        :param key: The key of this UserRemovesshkeyBody.  # noqa: E501
        :type: object
        """
        if key is None:
    ...
    @property
    def id(self):
        """Gets the id of this UserRemovesshkeyBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this UserRemovesshkeyBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserRemovesshkeyBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this UserRemovesshkeyBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserRemovesshkeyBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserRemovesshkeyBody):
            return False
