...
class FtpaccountUpdatepathBody(object):
    ...
    def __init__(self, domain=None, ftp_user=None, path=None, id=None):  # noqa: E501
        """FtpaccountUpdatepathBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
        self._ftp_user = None
        self._path = None
        self._id = None
    ...
    @property
    def domain(self):
        """Gets the domain of this FtpaccountUpdatepathBody.  # noqa: E501

        Domain name.  # noqa: E501

        :return: The domain of this FtpaccountUpdatepathBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this FtpaccountUpdatepathBody.

        Domain name.  # noqa: E501

        :param domain: The domain of this FtpaccountUpdatepathBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def ftp_user(self):
        """Gets the ftp_user of this FtpaccountUpdatepathBody.  # noqa: E501

        FTP username.  # noqa: E501

        :return: The ftp_user of this FtpaccountUpdatepathBody.  # noqa: E501
        :rtype: object
        """
    ...
    def ftp_user(self, ftp_user):
        """Sets the ftp_user of this FtpaccountUpdatepathBody.

        FTP username.  # noqa: E501

        :param ftp_user: The ftp_user of this FtpaccountUpdatepathBody.  # noqa: E501
        :type: object
        """
        if ftp_user is None:
    ...
    @property
    def path(self):
        """Gets the path of this FtpaccountUpdatepathBody.  # noqa: E501

        Path related to the FTP account.  # noqa: E501

        :return: The path of this FtpaccountUpdatepathBody.  # noqa: E501
        :rtype: object
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this FtpaccountUpdatepathBody.

        Path related to the FTP account.  # noqa: E501

        :param path: The path of this FtpaccountUpdatepathBody.  # noqa: E501
        :type: object
        """
        if path is None:
    ...
    @property
    def id(self):
        """Gets the id of this FtpaccountUpdatepathBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this FtpaccountUpdatepathBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FtpaccountUpdatepathBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this FtpaccountUpdatepathBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FtpaccountUpdatepathBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FtpaccountUpdatepathBody):
            return False
