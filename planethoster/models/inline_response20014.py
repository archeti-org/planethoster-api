...
class InlineResponse20014(object):
    ...
    swagger_types = {
        'message': 'object',
        'epp_code_sent_to': 'object'
    }

    attribute_map = {
        'message': 'message',
        'epp_code_sent_to': 'epp_code_sent_to'
    }

    def __init__(self, message=None, epp_code_sent_to=None):  # noqa: E501
        """InlineResponse20014 - a model defined in Swagger"""  # noqa: E501
        self._message = None
        self._epp_code_sent_to = None
        self.discriminator = None
        if message is not None:
            self.message = message
        if epp_code_sent_to is not None:
            self.epp_code_sent_to = epp_code_sent_to

    @property
    def message(self):
        """Gets the message of this InlineResponse20014.  # noqa: E501

        EPP code successfully sent to registrant email.  # noqa: E501
    ...
    @property
    def epp_code_sent_to(self):
        """Gets the epp_code_sent_to of this InlineResponse20014.  # noqa: E501

        Account administrator email.  # noqa: E501

        :return: The epp_code_sent_to of this InlineResponse20014.  # noqa: E501
        :rtype: object
        """
        return self._epp_code_sent_to

    @epp_code_sent_to.setter
    def epp_code_sent_to(self, epp_code_sent_to):
        """Sets the epp_code_sent_to of this InlineResponse20014.

        Account administrator email.  # noqa: E501

        :param epp_code_sent_to: The epp_code_sent_to of this InlineResponse20014.  # noqa: E501
        :type: object
        """

        self._epp_code_sent_to = epp_code_sent_to
