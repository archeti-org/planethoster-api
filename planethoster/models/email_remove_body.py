...
class EmailRemoveBody(object):
    ...
    def __init__(self, domain=None, mail_user=None, id=None):  # noqa: E501
        """EmailRemoveBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
    ...
    @property
    def domain(self):
        """Gets the domain of this EmailRemoveBody.  # noqa: E501

        Domain name.  # noqa: E501

        :return: The domain of this EmailRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this EmailRemoveBody.

        Domain name.  # noqa: E501

        :param domain: The domain of this EmailRemoveBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def mail_user(self):
        """Gets the mail_user of this EmailRemoveBody.  # noqa: E501

        Email user.  # noqa: E501

        :return: The mail_user of this EmailRemoveBody.  # noqa: E501
        :rtype: object
        """
    ...
    def mail_user(self, mail_user):
        """Sets the mail_user of this EmailRemoveBody.

        Email user.  # noqa: E501

        :param mail_user: The mail_user of this EmailRemoveBody.  # noqa: E501
        :type: object
        """
    ...
    @property
    def id(self):
        """Gets the id of this EmailRemoveBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this EmailRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EmailRemoveBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this EmailRemoveBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailRemoveBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailRemoveBody):
            return False
