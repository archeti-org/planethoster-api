...
class ResellerapiTransfertdomainBody(object):
    ...
    def __init__(self, sld=None, tld=None, epp_code=None):  # noqa: E501
        """ResellerapiTransfertdomainBody - a model defined in Swagger"""  # noqa: E501
        self._sld = None
        self._tld = None
        self._epp_code = None
    ...
    @property
    def sld(self):
        """Gets the sld of this ResellerapiTransfertdomainBody.  # noqa: E501

        Domain name without the Top-Level Domain.  # noqa: E501

        :return: The sld of this ResellerapiTransfertdomainBody.  # noqa: E501
        :rtype: object
        """
        return self._sld
    ...
    @sld.setter
    def sld(self, sld):
        """Sets the sld of this ResellerapiTransfertdomainBody.

        Domain name without the Top-Level Domain.  # noqa: E501

        :param sld: The sld of this ResellerapiTransfertdomainBody.  # noqa: E501
        :type: object
        """
        if sld is None:
    ...
    @property
    def tld(self):
        """Gets the tld of this ResellerapiTransfertdomainBody.  # noqa: E501

        TLD without the leading period.  # noqa: E501

        :return: The tld of this ResellerapiTransfertdomainBody.  # noqa: E501
        :rtype: object
        """
        return self._tld
    ...
    @tld.setter
    def tld(self, tld):
        """Sets the tld of this ResellerapiTransfertdomainBody.

        TLD without the leading period.  # noqa: E501

        :param tld: The tld of this ResellerapiTransfertdomainBody.  # noqa: E501
        :type: object
        """
        if tld is None:
    ...
    @property
    def epp_code(self):
        """Gets the epp_code of this ResellerapiTransfertdomainBody.  # noqa: E501

        Transfer secret is a domain transfer secret (transfer key), a key or code.   # noqa: E501

        :return: The epp_code of this ResellerapiTransfertdomainBody.  # noqa: E501
        :rtype: object
        """
        return self._epp_code

    @epp_code.setter
    def epp_code(self, epp_code):
        """Sets the epp_code of this ResellerapiTransfertdomainBody.

        Transfer secret is a domain transfer secret (transfer key), a key or code.   # noqa: E501

        :param epp_code: The epp_code of this ResellerapiTransfertdomainBody.  # noqa: E501
        :type: object
        """
        if epp_code is None:
            raise ValueError("Invalid value for `epp_code`, must not be `None`")  # noqa: E501

        self._epp_code = epp_code
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResellerapiTransfertdomainBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResellerapiTransfertdomainBody):
            return False
