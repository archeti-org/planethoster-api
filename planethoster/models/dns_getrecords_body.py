...
class DnsGetrecordsBody(object):
    ...
    def __init__(self, domain=None, id=None):  # noqa: E501
        """DnsGetrecordsBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
        self._id = None
    ...
    @property
    def domain(self):
        """Gets the domain of this DnsGetrecordsBody.  # noqa: E501

        Domain name   # noqa: E501

        :return: The domain of this DnsGetrecordsBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this DnsGetrecordsBody.

        Domain name   # noqa: E501

        :param domain: The domain of this DnsGetrecordsBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def id(self):
        """Gets the id of this DnsGetrecordsBody.  # noqa: E501
        ...
        :return: The id of this DnsGetrecordsBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DnsGetrecordsBody.

        ID number of the World account. It can be found with the command [/get-accounts](#operation/getAccounts).<br /><br /> <span style=\"color:red\">If you have a world account (hosting), the world account id is <strong>REQUIRED</strong>. If you only own the domain without a hosting account, it is possible to manage the zone with the domain only.</span>   # noqa: E501

        :param id: The id of this DnsGetrecordsBody.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DnsGetrecordsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DnsGetrecordsBody):
            return False
