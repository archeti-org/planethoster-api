...
class StatsApacheBody(object):
    ...
    def __init__(self, period=None, domain=None, id=None):  # noqa: E501
        """StatsApacheBody - a model defined in Swagger"""  # noqa: E501
        self._period = None
        self._domain = None
        self._id = None
    ...
    @property
    def period(self):
        """Gets the period of this StatsApacheBody.  # noqa: E501

        Search period  # noqa: E501

        :return: The period of this StatsApacheBody.  # noqa: E501
        :rtype: object
        """
        return self._period
    ...
    def period(self, period):
        """Sets the period of this StatsApacheBody.

        Search period  # noqa: E501

        :param period: The period of this StatsApacheBody.  # noqa: E501
        :type: object
        """
        if period is None:
    ...
    @property
    def domain(self):
        """Gets the domain of this StatsApacheBody.  # noqa: E501

        The target domain  # noqa: E501

        :return: The domain of this StatsApacheBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this StatsApacheBody.

        The target domain  # noqa: E501

        :param domain: The domain of this StatsApacheBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def id(self):
        """Gets the id of this StatsApacheBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this StatsApacheBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this StatsApacheBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this StatsApacheBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StatsApacheBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatsApacheBody):
            return False
