...
class WordpressRemoveBody(object):
    ...
    def __init__(self, path=None, id=None):  # noqa: E501
        """WordpressRemoveBody - a model defined in Swagger"""  # noqa: E501
        self._path = None
        self._id = None
    ...
    @property
    def path(self):
        """Gets the path of this WordpressRemoveBody.  # noqa: E501

        The installation path  # noqa: E501

        :return: The path of this WordpressRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this WordpressRemoveBody.

        The installation path  # noqa: E501

        :param path: The path of this WordpressRemoveBody.  # noqa: E501
        :type: object
        """
        if path is None:
    ...
    @property
    def id(self):
        """Gets the id of this WordpressRemoveBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this WordpressRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this WordpressRemoveBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this WordpressRemoveBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WordpressRemoveBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WordpressRemoveBody):
            return False
