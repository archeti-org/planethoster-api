...
class UserAddBody(object):
    ...
    def __init__(self, db_user=None, password=None, id=None):  # noqa: E501
        """UserAddBody - a model defined in Swagger"""  # noqa: E501
        self._db_user = None
        self._password = None
        self._id = None
    ...
    @property
    def db_user(self):
        """Gets the db_user of this UserAddBody.  # noqa: E501

        Database name.  # noqa: E501

        :return: The db_user of this UserAddBody.  # noqa: E501
        :rtype: object
        """
    ...
    def db_user(self, db_user):
        """Sets the db_user of this UserAddBody.

        Database name.  # noqa: E501

        :param db_user: The db_user of this UserAddBody.  # noqa: E501
        :type: object
        """
        if db_user is None:
            raise ValueError("Invalid value for `db_user`, must not be `None`")  # noqa: E501

        self._db_user = db_user

    @property
    def password(self):
        """Gets the password of this UserAddBody.  # noqa: E501

        Email account password.  # noqa: E501

        :return: The password of this UserAddBody.  # noqa: E501
        :rtype: object
        """
    ...
    def password(self, password):
        """Sets the password of this UserAddBody.

        Email account password.  # noqa: E501

        :param password: The password of this UserAddBody.  # noqa: E501
        :type: object
        """
        if password is None:
    ...
    @property
    def id(self):
        """Gets the id of this UserAddBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this UserAddBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserAddBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this UserAddBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserAddBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserAddBody):
            return False
