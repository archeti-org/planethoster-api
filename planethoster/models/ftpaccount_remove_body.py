...
class FtpaccountRemoveBody(object):
    ...
    def __init__(self, domain=None, ftp_user=None, id=None):  # noqa: E501
        """FtpaccountRemoveBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
        self._ftp_user = None
        self._id = None
    ...
    @property
    def domain(self):
        """Gets the domain of this FtpaccountRemoveBody.  # noqa: E501

        Domain name.  # noqa: E501

        :return: The domain of this FtpaccountRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this FtpaccountRemoveBody.

        Domain name.  # noqa: E501

        :param domain: The domain of this FtpaccountRemoveBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def ftp_user(self):
        """Gets the ftp_user of this FtpaccountRemoveBody.  # noqa: E501

        FTP username.  # noqa: E501

        :return: The ftp_user of this FtpaccountRemoveBody.  # noqa: E501
        :rtype: object
        """
    ...
    def ftp_user(self, ftp_user):
        """Sets the ftp_user of this FtpaccountRemoveBody.

        FTP username.  # noqa: E501

        :param ftp_user: The ftp_user of this FtpaccountRemoveBody.  # noqa: E501
        :type: object
        """
        if ftp_user is None:
    ...
    @property
    def id(self):
        """Gets the id of this FtpaccountRemoveBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this FtpaccountRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FtpaccountRemoveBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this FtpaccountRemoveBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FtpaccountRemoveBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FtpaccountRemoveBody):
            return False
