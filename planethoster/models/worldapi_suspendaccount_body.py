...
class WorldapiSuspendaccountBody(object):
    ...
    def __init__(self, id=None, reason=None):  # noqa: E501
        """WorldapiSuspendaccountBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._reason = None
    ...
    @property
    def id(self):
        """Gets the id of this WorldapiSuspendaccountBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this WorldapiSuspendaccountBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this WorldapiSuspendaccountBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this WorldapiSuspendaccountBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    @property
    def reason(self):
        """Gets the reason of this WorldapiSuspendaccountBody.  # noqa: E501

        Reason for the suspension.  # noqa: E501

        :return: The reason of this WorldapiSuspendaccountBody.  # noqa: E501
        :rtype: object
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this WorldapiSuspendaccountBody.

        Reason for the suspension.  # noqa: E501

        :param reason: The reason of this WorldapiSuspendaccountBody.  # noqa: E501
        :type: object
        """
        if reason is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WorldapiSuspendaccountBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WorldapiSuspendaccountBody):
            return False
