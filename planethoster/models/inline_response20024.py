...
class InlineResponse20024(object):
    ...
    def __init__(self, account_unsuspended=None, message=None):  # noqa: E501
        """InlineResponse20024 - a model defined in Swagger"""  # noqa: E501
        self._account_unsuspended = None
        self._message = None
        self.discriminator = None
        if account_unsuspended is not None:
            self.account_unsuspended = account_unsuspended
        if message is not None:
            self.message = message

    @property
    def account_unsuspended(self):
        """Gets the account_unsuspended of this InlineResponse20024.  # noqa: E501

        Is the account unsuspended or not?  # noqa: E501

        :return: The account_unsuspended of this InlineResponse20024.  # noqa: E501
        :rtype: object
        """
        return self._account_unsuspended

    @account_unsuspended.setter
    def account_unsuspended(self, account_unsuspended):
        """Sets the account_unsuspended of this InlineResponse20024.

        Is the account unsuspended or not?  # noqa: E501

        :param account_unsuspended: The account_unsuspended of this InlineResponse20024.  # noqa: E501
        :type: object
        """

        self._account_unsuspended = account_unsuspended

    @property
    def message(self):
        """Gets the message of this InlineResponse20024.  # noqa: E501

        Successfully unsuspended account.  # noqa: E501
