...
class EmailSetBody(object):
    ...
    def __init__(self, email=None, id=None):  # noqa: E501
        """EmailSetBody - a model defined in Swagger"""  # noqa: E501
        self._email = None
        self._id = None
    ...
    @property
    def email(self):
        """Gets the email of this EmailSetBody.  # noqa: E501

        Cron email.  # noqa: E501

        :return: The email of this EmailSetBody.  # noqa: E501
        :rtype: object
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this EmailSetBody.

        Cron email.  # noqa: E501

        :param email: The email of this EmailSetBody.  # noqa: E501
        :type: object
        """
        if email is None:
    ...
    @property
    def id(self):
        """Gets the id of this EmailSetBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this EmailSetBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EmailSetBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this EmailSetBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailSetBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailSetBody):
            return False
