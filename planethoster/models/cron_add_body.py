...
class CronAddBody(object):
    ...
    def __init__(self, schedule=None, command=None, id=None):  # noqa: E501
        """CronAddBody - a model defined in Swagger"""  # noqa: E501
        self._schedule = None
        self._command = None
        self._id = None
    ...
    @property
    def schedule(self):
        """Gets the schedule of this CronAddBody.  # noqa: E501

        Cron schedule.  # noqa: E501

        :return: The schedule of this CronAddBody.  # noqa: E501
        :rtype: object
        """
    ...
    def schedule(self, schedule):
        """Sets the schedule of this CronAddBody.

        Cron schedule.  # noqa: E501

        :param schedule: The schedule of this CronAddBody.  # noqa: E501
        :type: object
        """
        if schedule is None:
    ...
    @property
    def command(self):
        """Gets the command of this CronAddBody.  # noqa: E501

        Cron command.  # noqa: E501

        :return: The command of this CronAddBody.  # noqa: E501
        :rtype: object
        """
    ...
    def command(self, command):
        """Sets the command of this CronAddBody.

        Cron command.  # noqa: E501

        :param command: The command of this CronAddBody.  # noqa: E501
        :type: object
        """
        if command is None:
    ...
    @property
    def id(self):
        """Gets the id of this CronAddBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this CronAddBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CronAddBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this CronAddBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CronAddBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CronAddBody):
            return False
