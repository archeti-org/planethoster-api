...
class UserRemoveBody(object):
    ...
    def __init__(self, db_user=None, id=None):  # noqa: E501
        """UserRemoveBody - a model defined in Swagger"""  # noqa: E501
        self._db_user = None
        self._id = None
    ...
    @property
    def db_user(self):
        """Gets the db_user of this UserRemoveBody.  # noqa: E501

        Database name.  # noqa: E501

        :return: The db_user of this UserRemoveBody.  # noqa: E501
        :rtype: object
        """
    ...
    def db_user(self, db_user):
        """Sets the db_user of this UserRemoveBody.

        Database name.  # noqa: E501

        :param db_user: The db_user of this UserRemoveBody.  # noqa: E501
        :type: object
        """
        if db_user is None:
    ...
    @property
    def id(self):
        """Gets the id of this UserRemoveBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this UserRemoveBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserRemoveBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this UserRemoveBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserRemoveBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserRemoveBody):
            return False
