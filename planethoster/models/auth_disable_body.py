...
class AuthDisableBody(object):
    ...
    def __init__(self, domain=None, mail_user=None, auth=None, id=None):  # noqa: E501
        """AuthDisableBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
    ...
    @property
    def domain(self):
        """Gets the domain of this AuthDisableBody.  # noqa: E501

        Domain name.  # noqa: E501

        :return: The domain of this AuthDisableBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this AuthDisableBody.

        Domain name.  # noqa: E501

        :param domain: The domain of this AuthDisableBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def mail_user(self):
        """Gets the mail_user of this AuthDisableBody.  # noqa: E501

        Email user.  # noqa: E501

        :return: The mail_user of this AuthDisableBody.  # noqa: E501
        :rtype: object
        """
    ...
    def mail_user(self, mail_user):
        """Sets the mail_user of this AuthDisableBody.

        Email user.  # noqa: E501

        :param mail_user: The mail_user of this AuthDisableBody.  # noqa: E501
        :type: object
        """
    ...
    @property
    def auth(self):
        """Gets the auth of this AuthDisableBody.  # noqa: E501

        Email authentication.  # noqa: E501

        :return: The auth of this AuthDisableBody.  # noqa: E501
        :rtype: object
        """
        return self._auth
    ...
    @auth.setter
    def auth(self, auth):
        """Sets the auth of this AuthDisableBody.

        Email authentication.  # noqa: E501

        :param auth: The auth of this AuthDisableBody.  # noqa: E501
        :type: object
        """
        if auth is None:
    ...
    @property
    def id(self):
        """Gets the id of this AuthDisableBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this AuthDisableBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this AuthDisableBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this AuthDisableBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthDisableBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthDisableBody):
            return False
