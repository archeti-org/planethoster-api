...
class CmsDeleteBody(object):
    ...
    def __init__(self, path=None, id=None):  # noqa: E501
        """CmsDeleteBody - a model defined in Swagger"""  # noqa: E501
        self._path = None
        self._id = None
    ...
    @property
    def path(self):
        """Gets the path of this CmsDeleteBody.  # noqa: E501

        Installation path  # noqa: E501

        :return: The path of this CmsDeleteBody.  # noqa: E501
        :rtype: object
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this CmsDeleteBody.

        Installation path  # noqa: E501

        :param path: The path of this CmsDeleteBody.  # noqa: E501
        :type: object
        """
        if path is None:
    ...
    @property
    def id(self):
        """Gets the id of this CmsDeleteBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this CmsDeleteBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CmsDeleteBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this CmsDeleteBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CmsDeleteBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CmsDeleteBody):
            return False
