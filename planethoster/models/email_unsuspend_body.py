...
class EmailUnsuspendBody(object):
    ...
    """
    swagger_types = {
        'emails': 'N0capiemailunsuspendEmails',
        'id': 'object'
    }
    ...
    def __init__(self, emails=None, id=None):  # noqa: E501
        """EmailUnsuspendBody - a model defined in Swagger"""  # noqa: E501
        self._emails = None
        self._id = None
    ...
    @property
    def emails(self):
        """Gets the emails of this EmailUnsuspendBody.  # noqa: E501


        :return: The emails of this EmailUnsuspendBody.  # noqa: E501
        :rtype: N0capiemailunsuspendEmails
        """
        return self._emails

    @emails.setter
    def emails(self, emails):
        """Sets the emails of this EmailUnsuspendBody.


        :param emails: The emails of this EmailUnsuspendBody.  # noqa: E501
        :type: N0capiemailunsuspendEmails
        """
        if emails is None:
    ...
    @property
    def id(self):
        """Gets the id of this EmailUnsuspendBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this EmailUnsuspendBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EmailUnsuspendBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this EmailUnsuspendBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailUnsuspendBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailUnsuspendBody):
            return False
