...
class EmailChangequotaBody(object):
    ...
    def __init__(self, domain=None, mail_user=None, quota=None, id=None):  # noqa: E501
        """EmailChangequotaBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
    ...
    @property
    def domain(self):
        """Gets the domain of this EmailChangequotaBody.  # noqa: E501

        Domain name.  # noqa: E501

        :return: The domain of this EmailChangequotaBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this EmailChangequotaBody.

        Domain name.  # noqa: E501

        :param domain: The domain of this EmailChangequotaBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def mail_user(self):
        """Gets the mail_user of this EmailChangequotaBody.  # noqa: E501

        Email user.  # noqa: E501

        :return: The mail_user of this EmailChangequotaBody.  # noqa: E501
        :rtype: object
        """
    ...
    def mail_user(self, mail_user):
        """Sets the mail_user of this EmailChangequotaBody.

        Email user.  # noqa: E501

        :param mail_user: The mail_user of this EmailChangequotaBody.  # noqa: E501
        :type: object
        """
    ...
    @property
    def quota(self):
        """Gets the quota of this EmailChangequotaBody.  # noqa: E501

        New email quota in MB.  # noqa: E501

        :return: The quota of this EmailChangequotaBody.  # noqa: E501
        :rtype: object
        """
        return self._quota
    ...
    def quota(self, quota):
        """Sets the quota of this EmailChangequotaBody.

        New email quota in MB.  # noqa: E501

        :param quota: The quota of this EmailChangequotaBody.  # noqa: E501
        :type: object
        """
        if quota is None:
    ...
    @property
    def id(self):
        """Gets the id of this EmailChangequotaBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this EmailChangequotaBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EmailChangequotaBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this EmailChangequotaBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailChangequotaBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailChangequotaBody):
            return False
