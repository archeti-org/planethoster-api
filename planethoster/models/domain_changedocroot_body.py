...
class DomainChangedocrootBody(object):
    ...
    def __init__(self, domain=None, docroot=None, id=None):  # noqa: E501
        """DomainChangedocrootBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
        self._docroot = None
        self._id = None
    ...
    @property
    def domain(self):
        """Gets the domain of this DomainChangedocrootBody.  # noqa: E501

        Existing domain name.  # noqa: E501

        :return: The domain of this DomainChangedocrootBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this DomainChangedocrootBody.

        Existing domain name.  # noqa: E501

        :param domain: The domain of this DomainChangedocrootBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def docroot(self):
        """Gets the docroot of this DomainChangedocrootBody.  # noqa: E501

        Domain document root.  # noqa: E501

        :return: The docroot of this DomainChangedocrootBody.  # noqa: E501
        :rtype: object
        """
    ...
    def docroot(self, docroot):
        """Sets the docroot of this DomainChangedocrootBody.

        Domain document root.  # noqa: E501

        :param docroot: The docroot of this DomainChangedocrootBody.  # noqa: E501
        :type: object
        """
        if docroot is None:
    ...
    @property
    def id(self):
        """Gets the id of this DomainChangedocrootBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this DomainChangedocrootBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DomainChangedocrootBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this DomainChangedocrootBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainChangedocrootBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainChangedocrootBody):
            return False
