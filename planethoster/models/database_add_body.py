...
class DatabaseAddBody(object):
    ...
    def __init__(self, name=None, id=None):  # noqa: E501
        """DatabaseAddBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._id = None
    ...
    @property
    def name(self):
        """Gets the name of this DatabaseAddBody.  # noqa: E501

        Database name.  # noqa: E501

        :return: The name of this DatabaseAddBody.  # noqa: E501
        :rtype: object
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DatabaseAddBody.

        Database name.  # noqa: E501

        :param name: The name of this DatabaseAddBody.  # noqa: E501
        :type: object
        """
        if name is None:
    ...
    @property
    def id(self):
        """Gets the id of this DatabaseAddBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this DatabaseAddBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DatabaseAddBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this DatabaseAddBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatabaseAddBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DatabaseAddBody):
            return False
