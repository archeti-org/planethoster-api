...
class FtpaccountPasswordBody(object):
    ...
    def __init__(self, domain=None, ftp_user=None, password=None, id=None):  # noqa: E501
        """FtpaccountPasswordBody - a model defined in Swagger"""  # noqa: E501
        self._domain = None
        self._ftp_user = None
        self._password = None
        self._id = None
    ...
    @property
    def domain(self):
        """Gets the domain of this FtpaccountPasswordBody.  # noqa: E501

        Domain name.  # noqa: E501

        :return: The domain of this FtpaccountPasswordBody.  # noqa: E501
        :rtype: object
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this FtpaccountPasswordBody.

        Domain name.  # noqa: E501

        :param domain: The domain of this FtpaccountPasswordBody.  # noqa: E501
        :type: object
        """
        if domain is None:
    ...
    @property
    def ftp_user(self):
        """Gets the ftp_user of this FtpaccountPasswordBody.  # noqa: E501

        FTP username.  # noqa: E501

        :return: The ftp_user of this FtpaccountPasswordBody.  # noqa: E501
        :rtype: object
        """
    ...
    def ftp_user(self, ftp_user):
        """Sets the ftp_user of this FtpaccountPasswordBody.

        FTP username.  # noqa: E501

        :param ftp_user: The ftp_user of this FtpaccountPasswordBody.  # noqa: E501
        :type: object
        """
        if ftp_user is None:
    ...
    @property
    def password(self):
        """Gets the password of this FtpaccountPasswordBody.  # noqa: E501

        Email account password.  # noqa: E501

        :return: The password of this FtpaccountPasswordBody.  # noqa: E501
        :rtype: object
        """
    ...
    def password(self, password):
        """Sets the password of this FtpaccountPasswordBody.

        Email account password.  # noqa: E501

        :param password: The password of this FtpaccountPasswordBody.  # noqa: E501
        :type: object
        """
        if password is None:
    ...
    @property
    def id(self):
        """Gets the id of this FtpaccountPasswordBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this FtpaccountPasswordBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FtpaccountPasswordBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this FtpaccountPasswordBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FtpaccountPasswordBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FtpaccountPasswordBody):
            return False
