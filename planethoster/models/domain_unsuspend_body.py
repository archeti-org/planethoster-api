...
class DomainUnsuspendBody(object):
    ...
    def __init__(self, domains=None, id=None):  # noqa: E501
        """DomainUnsuspendBody - a model defined in Swagger"""  # noqa: E501
        self._domains = None
        self._id = None
    ...
    @property
    def domains(self):
        """Gets the domains of this DomainUnsuspendBody.  # noqa: E501

        Domains to unsuspend.  # noqa: E501

        :return: The domains of this DomainUnsuspendBody.  # noqa: E501
        :rtype: object
        """
    ...
    def domains(self, domains):
        """Sets the domains of this DomainUnsuspendBody.

        Domains to unsuspend.  # noqa: E501

        :param domains: The domains of this DomainUnsuspendBody.  # noqa: E501
        :type: object
        """
        if domains is None:
    ...
    @property
    def id(self):
        """Gets the id of this DomainUnsuspendBody.  # noqa: E501

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :return: The id of this DomainUnsuspendBody.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DomainUnsuspendBody.

        World account ID. Can be found with [/get-accounts](#operation/getAccounts).  # noqa: E501

        :param id: The id of this DomainUnsuspendBody.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainUnsuspendBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainUnsuspendBody):
            return False
